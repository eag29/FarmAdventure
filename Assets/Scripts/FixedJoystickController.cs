...
public class FixedJoystickController : MonoBehaviour
{
    ...
    void JoystickControl()
    {
        ...
        Vector3 clampedPosition = Vector3.ClampMagnitude(targetScale - joytsickOutline.position, newWidth) + joytsickOutline.position;
        joytsickButton.position = clampedPosition;
